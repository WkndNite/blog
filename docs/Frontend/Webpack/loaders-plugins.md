...
在这之前，我们先来回顾之前提到的 [chunk 解析模块的流程](/Frontend/Webpack/compile-process#%E7%BC%96%E8%AF%91%E9%98%B6%E6%AE%B5)，并完善之前的流程图：

![alt](./assets/2020-01-13-09-35-44.png)

在新添加的处理 loaders 这一步，具体步骤又如下：

![alt](./assets/2020-01-13-10-29-54.png)
...
![alt](./assets/2020-01-15-12-45-16.png)
