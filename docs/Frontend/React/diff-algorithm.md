...
![alt](./assets/2023-02-28-032654.png)

继续往后面走，发现 div.key.b 也能够复用

![alt](./assets/2023-02-28-075146.png)

接下来继续往后面走，div.key.e，这个时候发现 key 不一样，因此第一轮遍历就结束了

![alt](./assets/2023-02-28-075345.png)
...
![alt](./assets/2023-02-28-075011.png)
...
![alt](./assets/2023-02-28-075725.png)

### 第二轮遍历

<mark>如果第一轮遍历被提前终止了，那么意味着有新的 React 元素或者旧的 FiberNode 没有遍历完，此时就会采用第二轮遍历。</mark>
...
![alt](./assets/2023-02-28-080358.png)
...
![alt](./assets/2023-02-28-080558.png)
...
![alt](./assets/2023-02-28-081414.png)

接下来会继续去遍历剩下的 JSX 对象数组，遍历的同时，从 map 里面去找有没有能够复用：

![alt](./assets/2023-02-28-081859.png)
...
![alt](./assets/2023-02-28-082152.png)
...
![alt](./assets/2023-02-28-085007.png)
